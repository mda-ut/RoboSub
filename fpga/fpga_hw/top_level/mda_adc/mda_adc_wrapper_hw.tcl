...
add_interface_port adc_slave addr address Input 4
add_interface_port adc_slave read_n read_n Input 1
add_interface_port adc_slave readdata readdata Output 16
add_interface_port adc_slave write_n write_n Input 1
add_interface_port adc_slave writedata writedata Input 16
