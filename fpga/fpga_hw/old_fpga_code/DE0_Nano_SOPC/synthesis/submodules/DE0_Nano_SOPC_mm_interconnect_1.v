...
module DE0_Nano_SOPC_mm_interconnect_1 (
	...
	wire  [79:0] sysid_control_slave_agent_rf_source_data;                                // sysid_control_slave_agent:rf_source_data -> sysid_control_slave_agent_rsp_fifo:in_data
	...
	wire  [79:0] sysid_control_slave_agent_rsp_fifo_out_data;                             // sysid_control_slave_agent_rsp_fifo:out_data -> sysid_control_slave_agent:rf_sink_data
	...
	wire  [78:0] cmd_mux_src_data;                                                        // cmd_mux:src_data -> sysid_control_slave_agent:cp_data
	...
	wire  [79:0] key_s1_agent_rf_source_data;                                             // key_s1_agent:rf_source_data -> key_s1_agent_rsp_fifo:in_data
	...
	wire  [79:0] key_s1_agent_rsp_fifo_out_data;                                          // key_s1_agent_rsp_fifo:out_data -> key_s1_agent:rf_sink_data
	...
	wire  [78:0] cmd_mux_001_src_data;                                                    // cmd_mux_001:src_data -> key_s1_agent:cp_data
	wire         cmd_mux_001_src_ready;                                                   // key_s1_agent:cp_ready -> cmd_mux_001:src_ready
	wire   [3:0] cmd_mux_001_src_channel;                                                 // cmd_mux_001:src_channel -> key_s1_agent:cp_channel
	...
	wire  [79:0] led_s1_agent_rf_source_data;                                             // led_s1_agent:rf_source_data -> led_s1_agent_rsp_fifo:in_data
	...
	wire  [79:0] led_s1_agent_rsp_fifo_out_data;                                          // led_s1_agent_rsp_fifo:out_data -> led_s1_agent:rf_sink_data
	...
	wire  [78:0] cmd_mux_002_src_data;                                                    // cmd_mux_002:src_data -> led_s1_agent:cp_data
	...
	wire  [79:0] sw_s1_agent_rf_source_data;                                              // sw_s1_agent:rf_source_data -> sw_s1_agent_rsp_fifo:in_data
	...
	wire  [79:0] sw_s1_agent_rsp_fifo_out_data;                                           // sw_s1_agent_rsp_fifo:out_data -> sw_s1_agent:rf_sink_data
	...
	wire  [78:0] cmd_mux_003_src_data;                                                    // cmd_mux_003:src_data -> sw_s1_agent:cp_data
	...
	wire  [78:0] clock_crossing_io_m0_agent_cp_data;                                      // clock_crossing_io_m0_agent:cp_data -> router:sink_data
	...
	wire  [78:0] sysid_control_slave_agent_rp_data;                                       // sysid_control_slave_agent:rp_data -> router_001:sink_data
	...
	wire  [78:0] key_s1_agent_rp_data;                                                    // key_s1_agent:rp_data -> router_002:sink_data
	...
	wire  [78:0] led_s1_agent_rp_data;                                                    // led_s1_agent:rp_data -> router_003:sink_data
	...
	wire  [78:0] sw_s1_agent_rp_data;                                                     // sw_s1_agent:rp_data -> router_004:sink_data
	...
	wire  [78:0] router_004_src_data;                                                     // router_004:src_data -> rsp_demux_003:sink_data
	...
	wire  [78:0] router_src_data;                                                         // router:src_data -> clock_crossing_io_m0_limiter:cmd_sink_data
	...
	wire  [78:0] clock_crossing_io_m0_limiter_cmd_src_data;                               // clock_crossing_io_m0_limiter:cmd_src_data -> cmd_demux:sink_data
	...
	wire  [78:0] rsp_mux_src_data;                                                        // rsp_mux:src_data -> clock_crossing_io_m0_limiter:rsp_sink_data
	...
	wire  [78:0] clock_crossing_io_m0_limiter_rsp_src_data;                               // clock_crossing_io_m0_limiter:rsp_src_data -> clock_crossing_io_m0_agent:rp_data
	...
	wire  [78:0] cmd_demux_src3_data;                                                     // cmd_demux:src3_data -> cmd_mux_003:sink0_data
	...
	wire  [78:0] rsp_demux_003_src0_data;                                                 // rsp_demux_003:src0_data -> rsp_mux:sink3_data
